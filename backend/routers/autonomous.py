    ...
    try:
        ...
        if orchestrator:
            ...
            results = await orchestrator.process_documents_enhanced(
                ...
                item_path,
                workflow_id,
                progress_callback=lambda stage, progress, message: update_workflow_progress(
                    workflow_id, stage, progress, message
                )
            )
        else:
...
def update_workflow_progress(workflow_id: str, stage: str, progress: float, message: str):
